    ...
    <div>
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <jet-form-section @submitted="addTeamMember">
                <template #title> Adicionar membro da equipe </template>

                <template #description>
                    Adicione um novo membro à sua equipe, permitindo que eles
                    colaborem com você.
                </template>
                ...
                <template #form>
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            Forneça o endereço de e-mail da pessoa que você
        ...
        >
            ...
            <jet-action-section class="mt-10 sm:mt-0">
                <template #title>Convites pendentes da equipe</template>

                <template #description>
                    Essas pessoas foram convidadas para sua equipe e foram
                    enviou um e-mail de convite. Eles podem se juntar à equipe
                    por aceitar o convite por email.
                </template>
