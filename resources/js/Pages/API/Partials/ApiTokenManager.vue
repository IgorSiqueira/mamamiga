<template>
    <div>
        ...
        <jet-form-section @submitted="createApiToken">
            <template #title> Criar token de API </template>

            <template #description>
                Os tokens de API permitem que serviços de terceiros sejam
                autenticados em nosso aplicativo em seu nome.
            </template>
        ...
        <div v-if="tokens.length > 0">
            ...
            <div class="mt-10 sm:mt-0">
                <jet-action-section>
                    <template #title> Gerenciar tokens de API </template>

                    <template #description>
                        Você pode excluir qualquer um dos seus tokens
                        existentes, se eles forem não é mais necessário.
                    </template>
        ...
        >
            <template #title> Excluir token API </template>
